...
<body class="font-sans bg-white text-black">
    ...
    <nav class="w-full py-3">
        <div class="container mx-auto px-2">
            <div class="flex flex-col sm:flex-row items-start">
                ...
                <a href="#" class="mx-auto my-6 sm:ml-auto sm:mr-0 sm:my-0 sm:text-right"><img class="h-48 lg:h-64"src="{{ URL::asset('img/brand.svg') }}" alt="Kelly Sullivan for House District 13 2018"></a>
            </div>
        </div>
    </nav>
    ...
    <section class="w-full py-4 bg-teal text-white">
        <div class="container mx-auto px-2">
            <h2 class="text-center">Splash</h2>
        </div>
    </section>
    ...
    <section class="py-4">
        <div class="container mx-auto px-2 sm:flex">
            <div class="sm:w-1/3">
                ...
                <h3 class="text-center">Header</h2>
                <p class="text-lg p-2">South Dakota deserves a state government that is willing to work together and collaborate on policy that represents all South Dakotans, not the personal or professional interests of politicians.</p>
            </div>
            <div class="sm:w-1/3">
                <span class="mb-2 block text-center text-orange"><i class="fas fa-arrow-right fa-5x"></i></span>
                <h3 class="text-center">Header</h2>
                <p class="text-lg p-2">We must elect leadership who stands up for freedom and liberty and allows all South Dakotans to pursue a life of happiness.</p>
            </div>
            <div class="sm:w-1/3">
                <span class="mb-2 block text-center text-orange"><i class="far fa-lightbulb fa-5x"></i></span>
                <h3 class="text-center">Header</h2>
                <p class="text-lg p-2">We must build a future for our children by enacting social and economic policies that are forward-minded and will not only keep South Dakotans here, but will bring the best and brightest to our great state.</p>
            </div>
        </div>
    </section>
    ...
    <section class="py-4 w-full bg-teal text-white">
        <div class="container mx-auto px-2">
            <h2 class="text-center">Contact Kelly</h2>
            <form class="w-full md:w-1/2 mb-4 m-auto" action="{{ url('contact') }}" method="POST">
                {{ csrf_field() }}

                <div class="my-6">
                    <label for="name" class ="block my-2 font-bold">Name:</label>
                    <input type="text" name="name" id="name" class="w-full h-10 p-2">
                </div>

                <div class="my-6">
                    <label for="email" class="block my-2 font-bold">Email Address:</label>
                    <input type="text" name="email" id="email" class="w-full h-10 p-2">
                </div>

                <div class="my-6">
                    <label for="subject" class="block my-2 font-bold">Subject:</label>
                    <input type="text" name="subject" id="subject" class="w-full h-10 p-2">
                </div>

                <div class="my-6">
                    <label for="body" class="block my-2 font-bold">Message:</label>
    ...
    <section class="py-4">
        <div class="container mx-auto px-2 text-center">
            <h2 class="text-center my-2">How to Contribute</h2>
            <p class="my-2">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consequatur natus voluptatem veritatis quisquam, nesciunt esse. </p>
